...
const messages = {
  es: {
    app: {
      ...
      mapTitle: "Mapa",
      mapDispositionALabel: "Disposición A",
      mapDispositionBLabel: "Disposición B",
      mapLayoutLabel: "Layout",
      mapHint: "El orden de las disposiciones no cambia el mapa.",
      ...
      visionFrom: "Visión desde",
      lineOfSightTitle: "Línea de visión",
      deleteSelected: "Borrar peanas",
      rotateSelectedLeft: "-15°",
      rotateSelectedRight: "+15°",
      ...
      selectionUnit: "{name} · {shape} · {side} · {dimensions} · {rotation}° · ({x}, {y}) um",
    ...
    editor: {
      ...
      ready: "Config asignado: {path}",
      dirty: "Cambios pendientes en borrador local.\nGuardar escribe {path}.",
      saved: "JSON guardado en {path}",
      downloaded: "Servidor local no disponible.\nJSON descargado: {path}",
      languageLabel: "EN",
    },
  },
  en: {
    app: {
      ...
      mapTitle: "Map",
      mapDispositionALabel: "Disposition A",
      mapDispositionBLabel: "Disposition B",
      mapLayoutLabel: "Layout",
      mapHint: "The disposition order does not change the map.",
      ...
      visionFrom: "Vision from",
      lineOfSightTitle: "Line of sight",
    ...
    editor: {
      ...
      ready: "Assigned config: {path}",
      dirty: "Pending changes in local draft.\nSave writes {path}.",
      saved: "JSON saved to {path}",
      downloaded: "Local server unavailable.\nDownloaded JSON: {path}",
      languageLabel: "ES",
    },
  },
};
